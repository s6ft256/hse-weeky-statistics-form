#!/usr/bin/env python3
"""
Local Development Server for AirtableClient Demo

This Flask server demonstrates the modernized AirtableClient with REST API endpoints.

Setup:
    1. Set environment variables: AIRTABLE_TOKEN, AIRTABLE_BASE_ID
...
# Initialize Airtable client (reads from environment variables)
try:
...
<head>
    ...
    <title>Airtable Client Server</title>
    <style>
